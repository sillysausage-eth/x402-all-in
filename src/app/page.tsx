 ...
 * Updated: Jan 9, 2026 - Replaced placeholder wallet button with OnchainKit ConnectWalletButton
 *                        Supports CDP embedded wallets, MetaMask, Trust, WalletConnect, etc.
 */
